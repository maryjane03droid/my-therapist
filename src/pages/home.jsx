    ...
    <section className="home-screen">
      <div className="home-hero">
        <div className="home-hero-content">
          ...
          <p className="home-hero-text">
            My Therapist is a calm and supportive space where you can track your
            mood, write private reflections, and get gentle AI support whenever
            you need it.
          </p>
        ...
        <div className="home-hero-visual">
          < FaLeaf className="home-hero-icon" />
        </div>
      </div>
      ...
      <div className="home-quick-grid">
        <Link to="/mood" className="home-feature-card card-green">
          ...
          <h3>Mood Tracker</h3>
          <p>
            Check in daily, log how you feel, and build a simple emotional
            pattern over time.
          </p>
        </Link>
        ...
        <Link to="/journal" className="home-feature-card card-peach">
          ...
          <p>
            Write your thoughts in a safe personal space and return to them
            whenever you need.
          </p>
        </Link>
        ...
        <Link to="/chat" className="home-feature-card card-blue">
          ...
          <p>
            Talk through your feelings and receive calm, supportive responses at
            any time.
          </p>
        </Link>
        ...
        <Link to="/support-group" className="home-feature-card card-lilac">
          ...
          <h3>Support Group</h3>
          <p>
            Find community, shared encouragement, and a reminder that others
            understand too.
          </p>
        </Link>
      </div>
      ...
      <div className="home-middle-layout">
        <div className="home-affirmation-card">
          ...
          <p>
            You do not need to fix everything today. A short note, one honest
            mood check-in, or one calm conversation can already be a meaningful
            step forward.
          </p>
        ...
        <div className="home-side-stack">
          <div className="home-side-card calm-card">
            ...
            <div>
              <h3>Calm Design</h3>
              <p>
                Soft colors, simple navigation, and emotionally safe spacing
          ...
          <div className="home-side-card warm-card">
            ...
            <div>
              ...
              <p>
                Your mood entries and reflections can help you notice emotional
          ...
          <div className="home-side-card support-card">
            ...
            <div>
              ...
              <p>
                AI support is available whenever you need a quiet place to pause
                and reflect.
              </p>
            </div>
          </div>
      ...
      <div className="home-bottom-section">
        <div className="home-bottom-card">
          ...
          <p>
            When people are struggling, they often need something that feels
            easy to start. My Therapist brings mood tracking, journaling, and
            supportive AI guidance into one calm experience so users can begin
            with whatever feels manageable in that moment.
          </p>
        </div>
        ...
        <div className="home-bottom-card">
          ...
          <p>
            Start with one action: log your mood, write a short note, or open
            the support chat. The goal is not perfection. The goal is to help
            you feel a little more supported than before.
          </p>
        </div>
      </div>
    </section>
